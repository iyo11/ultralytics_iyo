...
# 如果你安装了 timm 库，建议使用 DropPath，否则可以使用普通的 Dropout
try:
...
class Qwen_GatedAttention_SDPA(nn.Module):
    def __init__(self, d_model, n_heads=8, reduction_ratio=1, dropout=0.1, layerscale_init=1e-5):
        super().__init__()
        ...
        # 【正则化 2】：LayerScale - 赋予模型学习“跳过”不重要层的能力
    ...
    def forward(self, x):
        ...
        # 【核心改进】：使用 SDPA 内置的 dropout_p
        # 4090 上的 FlashAttention 对此有极致优化
