...
# 论文;https://ieeexplore.ieee.org/document/10671587
# 代码链接在论文里面
__all__ = ['EFC', 'MSEF']
...
class MSEF(nn.Module):  # 多尺度有效融合模块
    ...
    def forward(self, x):
        ...
        temp = self.channel_att(X_GOBAL)  # 改进1，在这里添加一个通道注意力，用于残差连接，恢复丢失的细节特征
        ...
        xL = xL + x_gui + temp  # temp用于残差连接
        out = self.local_att(xL)  # 通过位置注意力模块
        return out
