...
__all__ = ['C3k2_BFAM_1', 'C3k2_BFAM_2']
...
class C3k2_BFAM_1(C2f):
    ...
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        self.m = nn.ModuleList(
            C3k(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_BFAM(self.c, self.c, shortcut, g) for _ in
            range(n)
        )
...
class C3k2_BFAM_2(C2f):
    ...
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(
            C3kBFAM(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck(self.c, self.c, shortcut, g) for _ in
            range(n)
        )
        # 解析利用Bottleneck_iAFF替换Bottneck
